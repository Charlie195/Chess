...
public class LeaderboardGUI {
    ...
    public LeaderboardGUI(final String firstName, final String secondName, final int winner) {
        ...
        if (winner == 0) {
            ...
            JOptionPane.showMessageDialog(null, firstName + " Won", "White Checkmate", JOptionPane.INFORMATION_MESSAGE,
                    whiteKing);
        } else if (winner == 2) {
            JOptionPane.showMessageDialog(null, secondName + " Won", "Black Checkmate", JOptionPane.INFORMATION_MESSAGE,
                    blackKing);
        }
